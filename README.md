...
[https://academicresults.streamlit.app/](https://academicresults.streamlit.app/)
...
### 1. Clone the repo
```bas
git clone https://github.com/Anandudayprakash/RESULTS.git
cd Results
```
...
**Made by:** Anand uday prakash

- - GitHub: **@Anandudayprakash**
- Live App: [https://academicresults.streamlit.app/](https://academicresults.streamlit.app/)
